...
\begin{itemize}
	...
	\item Probabilidad de ocurrencia (O): 2. La empresa provee el hardware y es socio de nivel gold del fabricante, condición que le da un canal de aprovisionamiento directo. El antecedente disponible es un pedido recibido dentro de las dos semanas, plazo que los sprints de tres semanas y el período de contingencia absorben sin desplazar el cronograma.
\end{itemize}
...
Criterio adoptado: se elaboran planes de mitigación para los riesgos cuyo RPN resulta mayor que 30. Los riesgos R3, R4, R6, R7 y R8 quedan por debajo de ese umbral y se someten a seguimiento, sin acción de mitigación específica.

Nota: los valores marcados con asterisco corresponden a la situación posterior a la aplicación de la mitigación. Las filas que no los presentan corresponden a riesgos que, por quedar debajo del umbral, no requieren un plan de mitigación.
